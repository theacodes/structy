# Hey this file was generated by Structy on 2021-01-09 19:45:11.240421 from
...
class GemSettings(structy.Struct):
    ...
    castor_knob_min: fix16.Fix16 = fix16.Fix16(-1.01)
    """Configuration for the CV knob mins and maxs in volts, defaults to -1.01 to +1.01."""

    castor_knob_max: fix16.Fix16 = fix16.Fix16(1.01)

    pollux_knob_min: fix16.Fix16 = fix16.Fix16(-1.01)

    pollux_knob_max: fix16.Fix16 = fix16.Fix16(1.01)

    chorus_max_intensity: fix16.Fix16 = fix16.Fix16(0.05)
    """Maximum amount that the chorus can impact Pollux's frequency."""

    chorus_max_frequency: fix16.Fix16 = fix16.Fix16(0.2)
    """Maximum frequency that the chorus can run at in hertz."""

    knob_offset_corr: fix16.Fix16 = fix16.Fix16(0.0)
    """Error correction for the ADC readings for the CV and PWM knobs."""

    knob_gain_corr: fix16.Fix16 = fix16.Fix16(1.0)

    smooth_initial_gain: fix16.Fix16 = fix16.Fix16(0.1)
    """Pitch input CV smoothing parameters."""

    smooth_sensitivity: fix16.Fix16 = fix16.Fix16(30.0)
